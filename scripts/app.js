new Vue({
    ...
    data: {
        tasks: [
            { body: 'Eggs', completed: true },
            { body: 'Bacon', completed: true },
            { body: 'Beans', completed: false },
            { body: 'Bread', completed: false },
            { body: 'Coffee', completed: false },
            { body: 'Mushrooms', completed: false },
            { body: 'Milk', completed: false },
        ],
